...
<div class="compare-database-block">
    ...
    <?php $query = ""; ?>
                                ...
                                <span <?php if (isset($tparam['changeType']) && $tparam['changeType']): ?>style="color: red;" class="new" <?php endif;?>>
                                    <?php 
                                        if (isset($tparam['isNew']) && $tparam['isNew']) {
                                            $query .= 'ALTER TABLE '.$tableName.' ADD '.$fieldName." ".$tparam['dtype'].' NULL;<br>';
                                        }
                                    ?>
        ...
        <tr>
            <td colspan="2"> <code><span class="sample-data"><?php echo $query; ?></span></code></td>
        </tr>
        <?
            $fullquery .= $query;
        ?>
    <?php } ?>
        <tr>
            <td colspan="2" style="margin-top:30px"> <code><span class="sample-data"><?php echo $fullquery; ?></span></code></td>
        </tr>
    </table>
</div>
</body>
