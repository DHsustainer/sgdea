<?
	...
	class ESuscriptores_big_data{ 
		...
		public $suscriptores_referencias_id;
		...
		function Suscriptores_big_data()
		{
			$this->id=$this->SetId("");
			$this->username=$this->SetUsername("");
			$this->suscriptor_id=$this->SetSuscriptor_id("");
			$this->suscriptores_referencias_id=$this->SetSuscriptores_referencias_id("");
		...
		function SetSuscriptores_referencias_id($some)
		{
			$this->suscriptores_referencias_id=$some;
		}
		...
		function GetSuscriptores_referencias_id()
		{
			return $this->suscriptores_referencias_id;
		}
