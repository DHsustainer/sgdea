...
<script language='javascript' type='text/javascript' src='<?= APP.'views'.DS.'libros'.DS.'scripts'.DS ?>script.js'></script>
	<form id='FormUpdatesuscriptores_big_data' action='/suscriptores_big_data/actualizar/' method='POST'> 
		<div class='title'>Editar suscriptores_big_data</div>
		<!--<table border='0' width='40%' cellspacing='10'>
			<tr>
				<td colspan='2' align='left' class='sub_titulo'>Editar suscriptores_big_data</td>
			</tr> -->
			...
			<input type='text' class='form-control' placeholder='suscriptores_referencias_id' name='suscriptores_referencias_id' id='suscriptores_referencias_id' maxlength='' value='<? echo $object -> Getsuscriptores_referencias_id(); ?>' />
