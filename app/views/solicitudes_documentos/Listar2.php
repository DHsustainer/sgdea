					...
					<form action="/solicitudes_documentos/buscar/" method="POST">
						...
						<div class="row" style="margin-left:0px; margin-top: 0px;">
							<div class="2u 12u(narrower) ">
								<input type="text" name="fechai" value="<?= $fi ?>" id="fechai" style="height:35px;" placeholder="Fecha de inicio" class="datepicker input1_0 form-control important">
							</div>
							<div class="2u 12u(narrower) ">
								<input type="text" name="fechaf" value="<?= $ff ?>" id="fechaf" style="height:35px;" placeholder="Fecha de Corte" class="datepicker input1_0 form-control important">
							</div>
							<div class="2u 12u(narrower) ">
					...
					<table border='0' cellspacing='0' cellpadding='3' width='100%' class='tabla' id='Tablasolicitudes_documentos'>
			           	<thead>
							<tr class='encabezado'>
								...
								<th width="170px"class='th_act'>Solicitado a</th>
...
<?
		...
		while($row = $con->FetchAssoc($query)){
			...
			$usuarios_s->CreateUsuarios("user_id", $l->GetUsuario_destino());
