<form id='formgestion' method='POST' action="/informes/getcitas/" target="_blank"> 
    <div class="row m-t-20">
        ...
        <div class="col-md-4">
            <h4>Ignorar Registros sin Cita</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            <select class="form-control" name="ignorar" id="ignorar">
