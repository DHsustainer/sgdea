...
?>
		...
		<div id="del-buscar">
			<form action="/gestion/inventario/" method="POST">
				<button id="del-button-buscar">Buscar</button>
				<input type="text" id="id" name="id" placeholder="Escriba el número de radicado" value="<?= $g->GetNum_oficio_respuesta() ?>" style="width:300px">
				<input type="hidden" id="cn" name="cn" value="R">
			</form>
		</div>
		<div id="del-right">
			<div id="del-user">
