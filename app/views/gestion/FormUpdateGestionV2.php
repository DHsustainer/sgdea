...
<div class="row">
    <div class="col-md-12 panel">
        <div class="white-panel">
        <div id="form" class="row" >
            <div class="col-md-7 col-xs-12 p-t-0" id="bloque_cuerpo_gestion">
...
?>
        <li class="opcion menu-expediente anexos hidden-xs" id="cargador_box_suscriptores"> 
...
<?
        ...
        if (M_TITULOSEGUIMIENTOSUSCRIPTORES == "1"){
?>            
        <li class="opcion menu-expediente anexos " id="cargador_box_seguimiento"> 
            <a href="/gestion/ver/<?= $object->GetId() ?>/seguimiento/"  class="fa fa-eye"  aria-expanded="false" ></a> 
        </li>
<?
        }
?>
...
<script type="text/javascript">
    ...
    function AdministrarDocumentos(id){
        var URL = '/gestion_anexos/listar_actualizar/'+id+'/';   
        $.ajax({
            type: 'POST',
            url: URL,
    ...
    <?
        ...
        $arx = array(   '' =>  '/gestion/GetAnexos/'.$object->GetId().'/0/1/',                                 
                        ...
                        'seguimiento' => '/gestion/Getseguimiento/'.$object->GetId().'/'.$_REQUEST['p1']."/",
        ...
        $ary = array(
                        ...
                        'seguimiento' => 'cargador_box_seguimiento',
...
?>
            ...
            <div class="col-md-5 col-xs-12 p-t-20" id="bloque_cuerpo_data">
                ...
                <div id="newbloque_formularios">
                    ...
                    ?>
                        <li role="presentation" id="newform"  <?= $c->Ayuda(81, 'tog') ?> class="dn">
...
/*
    function drop(target, evento) {
        ...
        var elm = caja;
        id_doc = $("#"+elm).attr('data-role');
        id_folder = $("#"+target.id).attr('data-role');
        //$("#"+elm).css("display", "none");

        //alert("mover documento "+id_doc+" a carpeta "+id_folder);
        $.ajax({
            type: "POST",
            url: '/gestion_anexos/cambiarcarpetadocumento/'+id_doc+'/'+id_folder+'/',
            success:function(msg){
                //alert(msg);
                window.location.reload()
            }
