                ...
                <form id='formgestion' action='/gestion/cargamasivapublica/' method='POST' class="validation-wizard wizard-circle m-t-40">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select style="width:100%; height:50px; margin-left:10px;" class="form-control required" name="tipo_documento" id="tipo_documento">
                                        ...
                                        <option value='2'>Procesos Ejecutivos</option>
                                    </select>
                                </div>
                    ...
                    <section>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div align="center">
                                    <input type='button' class="btn btn-primary btn-lg" style="height:60px;line-height:40px;padding-left:50px; margin-top:50px; padding-right:50px;font-size: 22px" value='Registrar' onClick="SendInnerExpedientes()"/>
                                </div>
