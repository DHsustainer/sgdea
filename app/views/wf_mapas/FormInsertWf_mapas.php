...
<script language='javascript' type='text/javascript' src='<?= APP.'views'.DS.'wf_mapas'.DS.'scripts'.DS ?>script.js'></script>
	<form id='formwf_mapas' action='/wf_mapas/registrar/' method='POST'> 
		<!--
    	<input type='hidden' id='m' name='m' value='wf_mapas' />     
    	<input type='hidden' id='action' name='action' value='registrar' />     
			<table border='0' cellspacing='3' cellpadding='0' class='tabla' width='40%'>
			<tr>
				<td colspan='2' align='left' class='sub_titulo'>{Formulariowf_mapas}</td>
			</tr>-->
		<div class='title right'>Formulario de wf_mapas </div>
