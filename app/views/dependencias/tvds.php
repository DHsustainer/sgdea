...
<?
	...
	$q = $areas->ListarAreas("", "order by nombre");
		...
		<table border="1" cellspacing="0" cellpadding="3" width="100%" class="tabla" id="tablat">
			<thead>
				...
				<tr>
					...
					<th class="th_act_inner" width="30px"  style="padding-left:5px; font-size: 8px; text-align: center">V</th>
...
<table border="0" style="border:1px solid #ccc;">
			...
			<tr>
				...
				<td class="impar">T</td>
				<td class="impar">= Tiempo de Valoración del Documento</td>
			</tr>
			<tr>
