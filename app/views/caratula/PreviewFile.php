...
echo "<div class='row' style='margin:0px'>
			...
			<div class='col-md-8 scrollable paneldocumento' style='overflow: hidden;overflow-y: auto;'>";

				/*if($bd_base_file != ""){



					if($base_file != $bd_base_file){

						echo "<div class='alert alert-danger'>El archivo que intenta visualizar fue corrompido</div>";
...
echo "		</div>";
	...
	if ($ga->GetTipologia() != "0") {
		...
		if ($MGestion_tipologias_big_data->GetId() == "") {
			...
			$MGestion_tipologias_big_data->InsertGestion_tipologias_big_data($_SESSION['usuario'], $ga->GetId(), $ga->GetTipologia(), $col_1, $col_2, $col_3, $col_4, $col_5, $col_6, $col_7, $col_8, $col_9, $col_10, $col_11, $col_12, $col_13, $col_14, $col_15);
...
*/
				...
				echo '<p>¿Problemas para visualizar el documento? <a href="'.$url.'" target="_blank" class="btn btn-info">Intentalo Aquí</a></p>';
					...
					<div id="blmeta-data">
						...
						<?
 							...
 							if($ga->GetTipologia() > 0){
								...
								echo "<div class='alert alert-info'>No se encuentran Tipologías Registradas</div>";
...
<script>
	...
	function UpdateTipologiaAnexo(){

		URL = '/gestion_tipologias_big_data/actualizar/';

		str = $("#FormUpdategestion_tipologias_big_data").serialize();
