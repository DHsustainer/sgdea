<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<h2><span class="fa fa-sliders"></span>Administracion de los Metadatos</h2>
							        ...
							        <div class="collapse navbar-collapse" id="mainNav">
							           ...
							           <ul id="navlist" class="nav nav-pills nav-stacked">
											...
											<li role="presentation" id="fmeta">
												...
												<a href="#" onClick="GetQuery('/meta_referencias_titulos/dependencia/<?= $id ?>/','fmeta', 'body-metadatosjs')">
				...
				<div class="col-md-9 body_metadatos">
					...
					<div class="row">
						...
						<div class="col-md-6"
							...
							<div class="col-md-12" id="inner-metadatosjs" >
...
GetQuery('/meta_referencias_titulos/dependencia/<?= $id ?>/2/','fmeta', 'body-metadatosjs');
