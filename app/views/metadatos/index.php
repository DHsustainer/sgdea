			...
			<div class="row">
				<div class="col-md-3">
				    <!--<div class="col-md-12"> -->
			    		...
			    		<div class="navbar navbar-default  p-t-20">
							        ...
							        <div class="collapse navbar-collapse" id="mainNav">
							           <ul id="navlist" class="nav nav-pills nav-stacked">
											...
											<li role="presentation" id="fmeta">
												<a href="#" onClick="GetQuery('/meta_referencias_titulos/','fmeta', 'body-metadatosjs')">
...
GetQuery('/meta_listas/','alistas', 'body-metadatosjs')
</script>
