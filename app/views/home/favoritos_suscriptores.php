                ...
                <div class="col-lg-2 col-md-3  col-sm-12 col-xs-12 inbox-panel">
                    <div> 
                        ...
                        <div class="list-group mail-list m-t-20"> 
                            ...
                            <a href="/dashboard/favoritos/" class="list-group-item active ">Favoritos</a> 
                    ...
                    <div class="inbox-center">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th colspan="4">
                                        <h4><?= CAMPOEXPEDIENTE."s Favoritos" ?></h4>
                                    </th>
                                <?
                                    ...
                                    $qr = $con->Query("select gestion_id from gestion_favoritos where tipo_user = 'S' and user_id = '".$_SESSION['suscriptor_id']."' order by id desc limit $RegistrosAEmpezar, $RegistrosAMostrar");


                                    $querypag = $con->Query("Select count(*) as t from gestion_favoritos where tipo_user = 'S' and user_id = '".$_SESSION['suscriptor_id']."'");
