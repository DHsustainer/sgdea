                ...
                <div class="col-lg-2 col-md-3  col-sm-12 col-xs-12 inbox-panel">
                    <div> 
                        ...
                        <div class="list-group mail-list m-t-20"> 
                            ...
                            <a href="/dashboard/boletin/" class="list-group-item active">Boletín</a> 
                        </div>
                    </div>
                </div>
                    ...
                    <div class="inbox-center">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th colspan="4">
                                        <h4><?= CAMPOEXPEDIENTE."s Públicos" ?></h4>
                                    </th>
                                <?
                                    ...
                                    $qr = $con->Query("select gestion.id from gestion where es_publico = '1' order by id desc limit $RegistrosAEmpezar, $RegistrosAMostrar");


                                    $querypag = $con->Query("select count(*) as t from gestion where  es_publico = '1'");
