...
<script language='javascript' type='text/javascript' src='<?= APP.'views'.DS.'libros'.DS.'scripts'.DS ?>script.js'></script>
	<form id='FormUpdateplantilla' action='<?= HOMEDIR.'plantilla'.DS.'actualizar'.DS ?>' method='POST' method='POST'> 
    	<input type='hidden' id='action' name='action' value='actualizar' />    
		
		
		<table border='0' width='40%' cellspacing='10'>
			<tr>
				<td colspan='2' align='left' class='sub_titulo'>Editar plantilla</td>
			</tr>
			...
			<tr>
				...
				<td><input type='text' name='t_plantilla' id='t_plantilla' maxlength='' value='<? echo $object -> Gett_plantilla(); ?>' /></td>
			</tr>
			<tr>
				<td width='30%'><strong>Def:</strong></td>
				<td><input type='text' name='def' id='def' maxlength='' value='<? echo $object -> Getdef(); ?>' /></td>
			</tr>
	<tr>
