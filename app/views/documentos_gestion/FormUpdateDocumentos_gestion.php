...
<script language='javascript' type='text/javascript' src='<?= APP.'views'.DS.'libros'.DS.'scripts'.DS ?>script.js'></script>
	<form id='FormUpdatedocumentos_gestion' action='<?= HOMEDIR.'documentos_gestion'.DS.'actualizar'.DS ?>' method='POST' method='POST'> 
    	<input type='hidden' id='action' name='action' value='actualizar' />    
		
		
		<table border='0' width='40%' cellspacing='10'>
			<tr>
				<td colspan='2' align='left' class='sub_titulo'>Editar documentos_gestion</td>
			</tr>
				<td style='display:none;'><input type='text' name='id' id='id' value='<? echo $object -> GetId(); ?>' /></td>
			<tr>
				<td width='30%'><strong>User_id:</strong></td>
				<td><input type='hidden' name='user_id' id='user_id' maxlength='' value='<? echo $object -> Getuser_id(); ?>' /></td>
			</tr>
			<tr>
				<td width='30%'><strong>Gestion_id:</strong></td>
				<td><input type='hidden' name='gestion_id' id='gestion_id' maxlength='' value='<? echo $object -> Getgestion_id(); ?>' /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type='hidden' name='f_creacion' id='f_creacion' maxlength='' value='<? echo $object -> Getf_creacion(); ?>' /></td>
			</tr>
			<tr>
				<td width='30%'><strong>F_actualizacion:</strong></td>
				<td><input type='hidden' name='f_actualizacion' id='f_actualizacion' maxlength='' value='<? echo $object -> Getf_actualizacion(); ?>' /></td>
			</tr>
			<tr>
